...
from utils import unique_list, make_buttons, correct_friends_order
...
def friends_paginator(connections):
    ...
    connections_info = db.get_users_in_list(connections)

    connections_info = correct_friends_order(connections_info, connections)
